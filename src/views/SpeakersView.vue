...
.sp-hero { padding:var(--sec-y) var(--sec-x);border-bottom:1px solid var(--line3);background:linear-gradient(160deg,var(--bg),var(--bg3)); }
...
.sp-title { font-size:var(--t-4xl);font-weight:800;letter-spacing:-.05em;line-height:1;margin-bottom:14px; }
.sp-title strong { color:var(--white); }
.sp-title em { font-family:var(--fs);font-style:italic;font-weight:400;color:var(--teal); }
.sp-sub { font-size:var(--t-md);color:var(--w3);font-weight:300;max-width:500px;line-height:1.7; }

.sp-wrap { max-width:1100px;margin:0 auto;padding:var(--sec-y) var(--sec-x); }
...
.spk-feat-tag { font-family:var(--fm);font-size:var(--t-2xs);font-weight:500;letter-spacing:.12em;text-transform:uppercase;color:var(--teal);margin-bottom:12px; }
.spk-feat-nm { font-size:var(--t-2xl);font-weight:800;color:var(--white);letter-spacing:-.04em;margin-bottom:6px; }
.spk-feat-rl { font-size:var(--t-sm);color:var(--w3);font-weight:300;margin-bottom:20px; }
.spk-feat-q { font-family:var(--fs);font-style:italic;font-size:var(--t-md);color:var(--w2);line-height:1.7;border-left:2px solid var(--teal-b);padding-left:16px; }
...
.spk-area-tag { position:absolute;top:14px;right:14px;font-family:var(--fm);font-size:var(--t-2xs);font-weight:600;padding:4px 8px;border-radius:100px;background:var(--teal-g);color:var(--teal);border:1px solid var(--teal-b);letter-spacing:.06em;z-index:2; }

.spk-av.md { width:80px;height:80px;font-size:var(--t-xl);z-index:1; }

.spk-card-info { padding:16px 16px;display:flex;flex-direction:column;gap:4px; }
.spk-nm { font-size:var(--t-lg);font-weight:700;color:var(--white);letter-spacing:-.02em; }
.spk-rl { font-size:var(--t-sm);color:var(--w3);font-weight:300;margin-bottom:8px; }
.spk-tp { font-size:var(--t-sm);font-weight:600;color:var(--teal); }
/* Avatares */
...
.spk-av.lg { width:100px;height:100px;font-size:var(--t-2xl); }
.spk-av.md { width:72px;height:72px;font-size:var(--t-lg);margin:32px auto 16px; }
...
@media (max-width: 900px) {
  .sp-hero { padding:var(--sec-y) var(--sec-x); }
  .sp-title { font-size:var(--t-4xl); }
  .sp-wrap { padding:var(--sec-y) var(--sec-x); }
